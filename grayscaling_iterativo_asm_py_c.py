...
if __name__ == '__main__':
  ...
  #######################################################################
    ...
    #######################################################################
      ...
      print(f"la funcion en python de {str(m)} es de {fin_py-inicio_py} segundos")
      print(f"la funcion en c de {str(m)} es de {fin_c-inicio_c} segundos")
      print(f"la funcion en asm de {str(m)} es de {fin_asm-inicio_asm} segundos")


    index = range(len(tiempopy))
    ...
    plt.plot(index, tiempopy, 'r-o', label="python")
    plt.plot(index2, tiempoasm, 'g-o', label="asm")
    plt.plot(index2, tiempoc, 'b-o', label="c")
    plt.legend()
    plt.tight_layout()
    ...
    plt.plot(index3, speeduppy, 'b-+', label="python")
    plt.plot(index3, speedupc, 'g-+', label="c")
    plt.legend()
    plt.tight_layout()
